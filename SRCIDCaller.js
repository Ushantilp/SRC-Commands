(function () {
	...
	// URL Handling
			...
			if (URLsplit3 == 'levels') {
				$.consoleLn('Please Select a Individual Level First!');
				return;
			} 
			if (URLsplit2 == 'users') {
				...
				$.consoleLn('The User ID for "'+ userName +'" is: '+ userID);
				return;
			}
	...
	// Game Name & ID Call
			...
			$.consoleLn('The Game ID for "' + gameName + '" is: ' + gameID);
	...
	// Indiviuale Level Check
			...
			if (URLCall.split("&x=l_")[1] != undefined) {
				...
				$.consoleLn('The Level ID for "' + lvlName + '" is: ' + lvlID);
				...
				ilID = ilJSON.data.id;
				$.consoleLn('The IL Category ID for "' + ilName + '" is: ' + ilID);
				var catID = ilID
				var ilFalse = lvlName
			}
			...
			// Cat Name & ID Call
				...
				$.consoleLn('The Category ID for "' + catName + '" is: ' + catID);
				}
	// Variable & Value Name & ID Call
		...
		// Var 1
			...
			if (var1Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var1Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val1ID = var1Split4;
			$.consoleLn('The Variable & Value ID for "' + var1Name + ': ' + val1Name + '" is: ' + var1ID + ' & ' + val1ID);
		// Var 2
			...
			if (var2Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var2Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val2ID = var2Split4;
			$.consoleLn('The Variable & Value ID for "' + var2Name + ': ' + val2Name + '" is: ' + var2ID + ' & ' + val2ID);
		// Var 3
			...
			if (var3Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var3Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val3ID = var3Split4;
			$.consoleLn('The Variable & Value ID for "' + var3Name + ': ' + val3Name + '" is: ' + var3ID + ' & ' + val3ID);
		// Var 4
			...
			if (var4Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var4Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val4ID = var4Split4;
			$.consoleLn('The Variable & Value ID for "' + var4Name + ': ' + val4Name + '" is: ' + var4ID + ' & ' + val4ID);
		// Var 5
			...
			if (var5Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var5Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val5ID = var5Split4;
			$.consoleLn('The Variable & Value ID for "' + var5Name + ': ' + val5Name + '" is: ' + var5ID + ' & ' + val5ID);
		// Var 6
			...
			if (var6Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var6Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val6ID = var6Split4;
			$.consoleLn('The Variable & Value ID for "' + var6Name + ': ' + val6Name + '" is: ' + var6ID + ' & ' + val6ID);
		// Var 7
			...
			if (var7Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var7Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val7ID = var7Split4;
			$.consoleLn('The Variable & Value ID for "' + var7Name + ': ' + val7Name + '" is: ' + var7ID + ' & ' + val7ID);
		// Var 8
			...
			if (var8Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var8Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val8ID = var8Split4;
			$.consoleLn('The Variable & Value ID for "' + var8Name + ': ' + val8Name + '" is: ' + var8ID + ' & ' + val8ID);
		// Var 9
			...
			if (var9Split2.split('.')[2] != undefined) {
				...
				$.consoleLn('There are to Many Values for "' + var9Name + '" selected, only one Value per variable are Supportet!')
				return;
			}
			...
			val9ID = var9Split4;
			$.consoleLn('The Variable & Value ID for "' + var9Name + ': ' + val9Name + '" is: ' + var9ID + ' & ' + val9ID);
		}
	});
})();